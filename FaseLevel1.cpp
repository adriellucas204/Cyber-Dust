...
void FaseLevel1::init() {
  ...
  enemyBullet[0] = new EnemyBulletHandler(*enemies[0], FaseLevel1::getScreen());
  objs.push_back(enemyBullet[0]);

  enemyBullet[1] = new EnemyBulletHandler(*enemies[1], FaseLevel1::getScreen());
  objs.push_back(enemyBullet[1]);

  heroBullet = new HeroBulletHandler(*hero, FaseLevel1::getScreen());
